  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          Container(width: 28, child: Text('To:', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: tc))),
        ...
        const SizedBox(height: 10),
        Row(children: [
          Container(width: 28, child: Text('From:', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: tc))),
          const SizedBox(width: 8),
