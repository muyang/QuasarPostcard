...
class PostcardTemplate {
  ...
  factory PostcardTemplate.fromJson(Map<String, dynamic> json) {
    return PostcardTemplate(
      id: json['id'] ?? '',
      name: json['name'] ?? '',
      templateGroup: json['template_group'] ?? '默认',
      gradientColors: [
      ...
      fromX: (json['from_x'] ?? 18).toDouble(),
      fromY: (json['from_y'] ?? 88).toDouble(),
      toX: (json['to_x'] ?? 60).toDouble(),
      toY: (json['to_y'] ?? 88).toDouble(),
      messageX: (json['message_x'] ?? 8).toDouble(),
      messageY: (json['message_y'] ?? 40).toDouble(),
      messageW: (json['message_w'] ?? 82).toDouble(),
      messageH: (json['message_h'] ?? 70).toDouble(),
      stampX: (json['stamp_x'] ?? 85).toDouble(),
      stampY: (json['stamp_y'] ?? 14).toDouble(),
      stampRotation: (json['stamp_rotation'] ?? 0).toDouble(),
      stampScale: (json['stamp_scale'] ?? 100).toDouble(),
      postmarkX: (json['postmark_x'] ?? 50).toDouble(),
      postmarkY: (json['postmark_y'] ?? 50).toDouble(),
